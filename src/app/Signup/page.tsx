          ...
          {/* hero sec of sihnup page */}
           <div>
            ...
            <div className="flex gap-2 justify-center mt-2">
                ...
                <Link href="/Signup" className="text-yellow-600">Sign up</Link>
            </div>
            </div>
                   ...
                   <h2 className="text-2xl font-bold text-gray-900 mb-6">Sign Up</h2>
                       ...
                       <form className="space-y-4">
                        <div className="flex gap-3">
                          <GoPerson className="text-slate-900 mt-1 h-8" />       
                        <input type="text" placeholder="Name" className="w-full text-slate-900 px-3 py-2 border rounded-md" />
